...
import APIService from '../../business-logic/APIService';
...
import styles from '../assets/styles/screens/ListScreenStyles';

function ListScreen(): React.JSX.Element {
  const docIcon = require('../assets/images/doc.on.doc.png');
  const trashIcon = require('../assets/images/trash.png');
  const peopleIcon = require('../assets/images/person.2.fill.png');
  const editIcon = require('../assets/images/square.and.pencil.png');
